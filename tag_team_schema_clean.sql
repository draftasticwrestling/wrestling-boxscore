-- Clean Tag Team Database Schema
-- Only includes wrestlers from current tag teams that are likely to exist
...
-- Tag team memberships - ONLY wrestlers that are likely to exist
-- Using conservative approach - only include wrestlers we're confident exist
INSERT INTO tag_team_members (tag_team_id, wrestler_slug, member_order) VALUES
-- RAW Teams
-- The New Day (only Kofi and Xavier - no Big E)
('new-day', 'kofi-kingston', 1),
('new-day', 'xavier-woods', 2),

-- The Judgment Day (core members only)
