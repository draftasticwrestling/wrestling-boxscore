-- Corrected Tag Team Database Schema
...
-- Sample tag team data (only teams with wrestlers that likely exist)
...
-- Sample tag team memberships (only wrestlers that likely exist)
-- These are based on wrestlers mentioned in the championship data and other files
INSERT INTO tag_team_members (tag_team_id, wrestler_slug, member_order) VALUES
-- The Usos (from championship data)
('usos', 'jimmy-uso', 1),
('usos', 'jey-uso', 2),

-- The Street Profits (from championship data)
('street-profits', 'montez-ford', 1),
('street-profits', 'angelo-dawkins', 2),

-- Imperium (from championship data - Gunther is mentioned)
('imperium', 'gunther', 1),
('imperium', 'ludwig-kaiser', 2),

-- Damage CTRL (from championship data - Iyo Sky is mentioned)
('damage-ctrl', 'io-sky', 1),
('damage-ctrl', 'bayley', 2),

-- The Judgment Day (from championship data - Dominik Mysterio is mentioned)
('judgment-day', 'dominik-mysterio', 1),
('judgment-day', 'finn-balor', 2),
('judgment-day', 'damian-priest', 3),

-- Legado del Fantasma (from championship data - Santos Escobar is mentioned)
('legado-del-fantasma', 'santos-escobar', 1),
('legado-del-fantasma', 'joaquin-wilde', 2),

-- Alpha Academy (from championship data - Chad Gable is mentioned)
