...
export default function MatchPageNew({ match, wrestlers = [], onEdit, wrestlerMap }) {
  ...
  return (
    <div style={{ background: '#181818', color: '#fff', borderRadius: 12, maxWidth: 1100, margin: '32px auto', padding: 32 }}>
      ...
      {/* Match Card Layout */}
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', gap: 0, marginBottom: 8 }}>
        {/* Left participant */}
        <div style={{ textAlign: 'center', position: 'relative', minWidth: 200, flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
